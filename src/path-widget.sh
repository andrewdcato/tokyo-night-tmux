...
SHOW_PATH=$(tmux show-option -gv @cato-theme-tmux_show_path 2>/dev/null)
PATH_FORMAT=$(tmux show-option -gv @cato-theme-tmux_path_format 2>/dev/null) # full | relative
